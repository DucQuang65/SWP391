...
public partial class BloodDonationSwp391Context : DbContext
{
    public BloodDonationSwp391Context()
    {
    }

    public BloodDonationSwp391Context(DbContextOptions<BloodDonationSwp391Context> options)
        : base(options)
    {
    }
